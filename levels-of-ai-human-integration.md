...
The below are suggested** levels of integration, when viewed from physical and ontological dimensions**, which can be used to combine an integration matrix, describing an overall level of integration. The levels can be viewed in as a kind 2D "[shock levels](http://sl4.org/shocklevels.html)" of integration.
